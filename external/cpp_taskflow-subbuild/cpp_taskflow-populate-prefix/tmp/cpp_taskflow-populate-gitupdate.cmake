...
execute_process(
  COMMAND "D:/Software/Git/Git/cmd/git.exe" --git-dir=.git show-ref "v3.6.0"
  WORKING_DIRECTORY "F:/Yicvot/Yicvot/external/cpp_taskflow-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'F:/Yicvot/Yicvot/external/cpp_taskflow-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'F:/Yicvot/Yicvot/external/cpp_taskflow-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
